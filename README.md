...
Driving the configuration experience is a [wizard](https://azure.github.io/Aks-Construction/?default=es), to guide your decision making, which caters for the main Enterprise-Scale deployment modes (Sandbox, Corp & Online).
